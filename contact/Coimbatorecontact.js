...
const Coimbatorecontact = () => {
  return (
    <div>
      {/* Header Section */}
      <div
        style={{
          backgroundImage:"url(/img/coimbatorecontact.jpg)",
          color: "white",
          textAlign: "center",
          padding: "80px 0",
        }}
      >
        <h1 style={{ fontWeight: "bold" }}>TRAVEL AGENCY IN COIMBATORE</h1>
        <h3>Contact Us</h3>
      </div>
      ...
      <Container className="mt-3">
        <Breadcrumb>
          ...
          <Breadcrumb.Item active>Travel agency in Coimbatore</Breadcrumb.Item>
        </Breadcrumb>
      </Container>
          ...
          <Col xs={12} md={4}>
            <Card className="text-center shadow-sm border-0">
              <Card.Body>
                ...
                <Card.Subtitle className="mb-2 text-muted">COIMBATORE</Card.Subtitle>
                <Card.Text>
...
export default Coimbatorecontact;